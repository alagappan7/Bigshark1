...
const LINKEDIN_CONFIG = {
  clientId: '787fdigjirobo6', // Replace with your LinkedIn app client ID
  redirectUri: 'https://hmbqprlkljqwqfdbdjoq.supabase.co/functions/v1/hyper-handler', // Must match LinkedIn app settings
  scope: 'openid profile email',
  state: '7896ksjdfhgsdfg' // Random string for CSRF protection
};
